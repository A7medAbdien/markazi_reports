...
Traceback (most recent call last):
  ...
  File "apps/frappe/frappe/core/doctype/report/report.py", line 180, in execute_module
    return frappe.get_attr(method_name)(frappe._dict(filters))
  File "apps/markazi_reports/markazi_reports/markazi_reports/report/sales_valuation_past/sales_valuation_past.py", line 94, in execute
    data = [
  File "apps/markazi_reports/markazi_reports/markazi_reports/report/sales_valuation_past/sales_valuation_past.py", line 113, in <listcomp>
...
```
{
	"exception": "AttributeError: 'dict' object has no attribute 'cost'",
